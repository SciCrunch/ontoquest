...
/**
 * @version $Id: GetSuperClasses.java,v 1.2 2012-04-30 22:42:46 xqian Exp $
 *
 */
public class GetSuperClasses extends GetNeighbors {
	...
	public GetSuperClasses(int[][] nodeIDs, int kbid, int level, boolean namedClassOnly) {
		super(nodeIDs, kbid, new String[] { "subClassOf" }, null,
