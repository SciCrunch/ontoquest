...
/**
 * @version $Id: SimpleClassNode.java,v 1.1 2010-10-28 06:29:58 xqian Exp $
 *
 */
public class SimpleClassNode extends BasicClassNode {
  ...
  public static Set<SimpleClassNode> get(String id, PropertyType[] propTypes, Context context) throws OntoquestException {
    int[] ontoId = ClassNode.parseId(id);
